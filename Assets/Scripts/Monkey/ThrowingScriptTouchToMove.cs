...
public class ThrowingScriptTouchToMove : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        coinPouchScript = coinPouchSystem.GetComponent<CoinPouchScriptTouchToMove>();
    }
    ...
    private void Update()
    {
        playerHealth = player.GetComponent<PlayerHealthTouchToMove>().GetCurrentHealth();
        DistanceToPlayer();
