...
public class PlayerHealthTouchToMove : MonoBehaviour
{
    ...
    private AnimationStateControllerTouchToMove anim;
    ...
    private void Start()
    {
        anim = GetComponent<AnimationStateControllerTouchToMove>();
